...
export default function LandingPage() {
    ...
    return (
        <div
            className={`fixed inset-0 flex flex-col items-center justify-center bg-white dark:bg-black transition-opacity duration-700 ease-out ${fadeOut ? 'opacity-0' : 'opacity-100'}`}
        >
